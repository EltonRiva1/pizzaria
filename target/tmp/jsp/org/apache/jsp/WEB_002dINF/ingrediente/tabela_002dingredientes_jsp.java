...
public final class tabela_002dingredientes_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<tfoot>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td colspan=\"5\">Ingredientes cadastrados: <span\r\n");
      out.write("\t\t\t\tid=\"quantidade-ingredientes\">");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\r\n");
          out.write("\t\t\t\t<td><button type=\"button\" class=\"btn btn-warning btn-editar\">\r\n");
          out.write("\t\t\t\t\t\t");
          ...
          out.write("\r\n");
          out.write("\t\t\t\t\t</button></td>\r\n");
          out.write("\t\t\t\t<td><button type=\"button\" class=\"btn btn-danger btn-deletar\">\r\n");
          out.write("\t\t\t\t\t\t");
