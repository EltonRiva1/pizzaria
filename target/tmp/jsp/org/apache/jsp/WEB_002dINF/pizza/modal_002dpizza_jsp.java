...
public final class modal_002dpizza_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div class=\"modal fade\" id=\"modal-pizza\" tabindex=\"-1\" role=\"dialog\"\r\n");
      ...
      out.write("\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t<h4 class=\"modal-title\">Informações da Pizza</h4>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t<label for=\"nome\">Nome:</label> <input id=\"nome\" name=\"nome\"\r\n");
      out.write("\t\t\t\t\t\tclass=\"form-control\"><label for=\"preco\">Preço:</label> <input\r\n");
      out.write("\t\t\t\t\t\tid=\"preco\" name=\"preco\" class=\"form-control\"><label\r\n");
      out.write("\t\t\t\t\t\tfor=\"categoria\">Categoria:</label> <select id=\"categoria\"\r\n");
      out.write("\t\t\t\t\t\tname=\"categoria\" class=\"form-control\">\r\n");
      out.write("\t\t\t\t\t\t");
      if (_jspx_meth_c_forEach_0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t\t\t\t</select> <label for=\"ingredientes\">Ingredientes:</label> <select\r\n");
      out.write("\t\t\t\t\t\tid=\"ingredientes\" name=\"ingredientes\" class=\"form-control\"\r\n");
