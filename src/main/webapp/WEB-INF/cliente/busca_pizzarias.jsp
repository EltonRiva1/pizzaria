	...
	<div class="container">
		...
		<section>
			<div id="consulta-pizzarias" class="well">
				<div class="row">
					<div class="col-sm-4">
						<label for="pizza_pesquisa">Que pizza você quer comer
							hoje?</label> <select id="pizza_pesquisa" class="form-control">
					...
					<div class="col-sm-4">
						<button id="btn-buscar" class="btn btn-primary">Buscar
							pizzarias</button>
					</div>
				</div>
			</div>
