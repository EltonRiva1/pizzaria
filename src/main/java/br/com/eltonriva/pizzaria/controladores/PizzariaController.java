...
import br.com.eltonriva.pizzaria.modelo.servicos.ServicoPizzaria;
...
public class PizzariaController {
	...
	public String index(Model model) {
		model.addAttribute("nomesPizzas", this.servicoPizza.listarNomesPizzasDisponiveis());
	...
	public String index(@PathVariable String nomePizza, Model model) {
		model.addAttribute("pizzarias", this.servicoPizzaria.listarPizzariasQueContem(nomePizza));
